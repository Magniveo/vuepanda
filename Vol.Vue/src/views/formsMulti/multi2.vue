        ...
        data() {
            return {
                ...
                editFormOptions: [[{"title":"姓名","required":true,"field":"Name","disabled":true},
                              ...
                              [{"title":"Describe","required":true,"field":"Describe","disabled":true},
                              ...
                              [{"title":"修改人","field":"Modifier","disabled":true},
                               {"type":"datetime","title":"ModifyDate","field":"ModifyDate","disabled":true}]],
                searchFormFileds: {"Name":"","PhoneNo":"","CreateDate":"","Creator":""},
                searchFormOptions: [[{"title":"姓名","field":"Name"},{"title":"电话",type:"phone","field":"PhoneNo"},{"type":"datetime","title":"CreateDate","field":"CreateDate","type":"datetime"},{"title":"创建人","field":"Creator"}]],
                columns: [{field:'Name',title:'姓名',type:'string',link:true,width:100,readonly:true,require:true,align:'left',sortable:true},
                       {field:'Describe',title:'Describe',type:'string',width:180,readonly:true,require:true,align:'left'},
                       ...
                       {field:'CreateDate',title:'CreateDate',type:'datetime',width:120,readonly:true,align:'left',sortable:true},
