...
var vueParam = {
  ...
  data () {
    return {
      ...
      searchFormOptions: [[{ "title": "角色名称", "field": "RoleName", "type": "text" }, { "title": "部门名称", "field": "DeptName", "type": "text" }, { "dataKey": "enable", "data": [], "title": "是否启用", "field": "Enable", "type": "select" }], [{ "dataKey": "tree_roles", "data": [], "title": "父级ID", "field": "ParentId", "type": "cascader" }, { "title": "CreateDate", "field": "CreateDate", "type": "datetime" }, { "title": "ModifyDate", "field": "ModifyDate", "type": "datetime" }]],
