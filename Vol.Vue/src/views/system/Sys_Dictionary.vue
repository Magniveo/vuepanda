    ...
    var vueParam = {
        ...
        data() {
            return {
                ...
                searchFormOptions: [[{"title":"字典编号","field":"DicNo"},{"title":"字典名称","field":"DicName","type":"textarea"},{"title":"父级ID","field":"ParentId","type":"number"}],[{"dataKey":"enable","data":[],"title":"是否启用","field":"Enable","type":"select"},{"title":"CreateDate","field":"CreateDate","type":"datetime"},{"title":"ModifyDate","field":"ModifyDate","type":"datetime"}]],
                columns: [{field:'Dic_ID',title:'字典ID',type:'int',width:90,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'ModifyDate',title:'ModifyDate',type:'datetime',width:150,readonly:true,align:'left',sortable:true}],
                detail: {
                    cnName:"字典明细",
