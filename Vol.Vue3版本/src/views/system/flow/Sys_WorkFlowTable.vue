...
<script>
    ...
    export default defineComponent({
        setup() {
            ...
            const searchFormOptions = ref([[{"dataKey":"audit","data":[],"title":"审批状态","field":"AuditStatus","type":"select"},{"title":"WorkName","field":"WorkName","type":"like"},{"title":"业务名称","field":"WorkTableName","type":"like"},{"title":"CreateDate","field":"CreateDate","type":"datetime"}]]);
