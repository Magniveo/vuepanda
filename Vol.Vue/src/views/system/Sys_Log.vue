    ...
    var vueParam = {
        ...
        data() {
            return {
                ...
                searchFormOptions: [[{"title":"请求地址","field":"Url","type":"text"},{"title":"用户IP","field":"UserIP","type":"text"},{"title":"服务器IP","field":"ServiceIP","type":"text"}],[{"title":"StratDate","field":"BeginDate","type":"datetime"},{"dataKey":"restatus","title":"响应状态","field":"Success","type":"dropList"},{"dataKey":"roles","title":"角色ID","field":"Role_Id","type":"select"}],[{"dataKey":"log","title":"日志类型","field":"LogType","colSize":12,"type":"checkbox"}]],
