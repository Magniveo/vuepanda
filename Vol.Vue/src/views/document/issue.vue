      ...
      data: [
        ...
        },
        {
          ...
          desc: [
            ...
            {
              text:
                "2、菜单设置页面,当前菜单的【视图/WorkTable】字段在Sys_Menu表中是否有重复(【视图/WorkTable】字段在Sys_Menu表中不能有重复)"
            },
            {
              text:
                "2、如果是代码生成器生成的页面也分配权限后还是提示权限，请检查代码生成器配置中的【真实WorkTable】与菜单设置中的【视图/WorkTable】是否一样"
            }
          ]
        },
        {
