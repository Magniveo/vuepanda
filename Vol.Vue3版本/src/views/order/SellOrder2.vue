        ...
        data() {
            return {
                ...
                editFormOptions: [[{"dataKey":"ordertype","title":"订单类型","required":true,"field":"OrderType","type":"select"},
                              ...
                              [{"title":"Remark","field":"Remark","colSize":8,"type":"textarea"},
                ...
                searchFormOptions: [[{"title":"运单号","field":"TranNo"},{"title":"销售订单号","field":"SellNo"},{"dataKey":"ordertype","title":"订单类型","field":"OrderType","type":"select"}],[{"dataKey":"audit","title":"AuditStatus","field":"AuditStatus","type":"select"},{"title":"审核时间","field":"AuditDate","type":"datetime"},{"title":"Auditor","field":"Auditor"}],[{"title":"创建人","field":"Creator"},{"title":"CreateDate","field":"CreateDate","type":"datetime"},{"title":"ModifyDate","field":"ModifyDate","type":"datetime"}]],
                columns: [{field:'Order_Id',title:'Id',type:'string',width:90,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'CreateDate',title:'CreateDate',type:'datetime',width:140,readonly:true,align:'left',sortable:true},
                       {field:'ModifyID',title:'ModifyID',type:'int',width:80,hidden:true,align:'left'},
                       {field:'Modifier',title:'修改人',type:'string',width:100,hidden:true,readonly:true,align:'left'},
                       {field:'ModifyDate',title:'ModifyDate',type:'datetime',width:140,readonly:true,align:'left',sortable:true}],
                detail: {
                    cnName:"订单明细",
                    table: "SellOrderList",
                    columns: [{field:'OrderList_Id',title:'OrderList_Id',type:'string',width:90,hidden:true,require:true,align:'left'},
                       ...
                       {field:'Remark',title:'Remark',type:'string',width:120,edit:{type:''},align:'left'},
                       {field:'CreateID',title:'CreateID',type:'int',width:80,hidden:true,align:'left'},
