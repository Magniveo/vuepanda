        ...
        data() {
            return {
                ...
                columns: [{field:'ExpertId',title:'主键ID',type:'int',width:80,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'AuditStatus',title:'AuditStatus',type:'int',bind:{ key:'audit',data:[]},width:120,require:true,align:'left'},
                       {field:'Auditor',title:'Auditor',type:'string',width:150,hidden:true,align:'left'},
                       ...
                       {field:'ModifyDate',title:'ModifyDate',type:'datetime',width:130,hidden:true,align:'left',sortable:true}],
                detail: {
                    cnName:"#detailCnName",
                    columns: [],
                    sortName: "",
